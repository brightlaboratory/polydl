...
def get_network(name, batch_size):
    ...
    if "resnet" in name:
        ...
        net = layers.conv2d( data=data, channels=int(64), kernel_size=(3, 3),strides=(1, 1), padding=(1, 1), name="conv0",data_layout=layout, kernel_layout="OIHW")
...
def tune_and_evaluate(tuning_opt):
    ...
    print("Extract tasks...")
   # mod = nn.conv2d(%1, %conv0_weight, strides=[2, 2], padding=[3, 3, 3, 3], channels=64, kernel_size=[7, 7])
   # %data: Tensor[(1, 3, 224, 224), float32]
   # %conv0_weight: Tensor[(64, 3, 7, 7), float32]
